...
-- NB : user_id est NULLABLE car un candidat peut ne pas encore avoir de compte.
-- Les colonnes email/first_name/last_name/phone/bio sont stockées sur la candidature
-- pour les candidats sans utilisateur encore créé.
-- Hibernate ddl-auto=update ajoute automatiquement les nouvelles colonnes de l'entité,
-- mais on garde ce schéma à jour pour les installations from-scratch.
...
-- EPREUVES LIBRES (FREE-FORM EXAMS)
