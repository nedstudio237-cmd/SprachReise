    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/trainers/me", "/api/trainers/me/**").authenticated()
                .requestMatchers("/api/trainer/students/**").authenticated()
                ...
                .requestMatchers("/api/auth/**", "/api/ping", "/api/courses/**", "/api/qcm/**", "/api/qcms/**", "/api/exams/**", "/api/sessions/**", "/api/files/**", "/api/admin/**", "/api/trainers/**", "/api/trainer-applications/**").permitAll()
