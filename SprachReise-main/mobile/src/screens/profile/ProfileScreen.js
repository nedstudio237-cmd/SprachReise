...
export default function ProfileScreen({ navigation }) {
  ...
  const photo = fileUrl(user?.photoUrl);
        ...
        <View style={styles.avatarSection}>
          ...
          {role === 'TRAINER' && (
            <>
              ...
              <TouchableOpacity
                style={[styles.editProfileBtn, { marginTop: 8 }]}
                onPress={() => navigation.navigate('MyCourses')}
              >
                <Text style={styles.editProfileBtnText}>MES COURS</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.editProfileBtn, { marginTop: 8 }]}
                onPress={() => navigation.navigate('MyQcms')}
              >
                <Text style={styles.editProfileBtnText}>MES QCM</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.editProfileBtn, { marginTop: 8 }]}
                onPress={() => navigation.navigate('MyExams')}
              >
                <Text style={styles.editProfileBtnText}>MES ÉPREUVES</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.editProfileBtn, { marginTop: 8 }]}
                onPress={() => navigation.navigate('MySessions')}
              >
                <Text style={styles.editProfileBtnText}>MES SESSIONS</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.editProfileBtn, { marginTop: 8 }]}
                onPress={() => navigation.navigate('MyStudents')}
              >
                <Text style={styles.editProfileBtnText}>MES APPRENANTS</Text>
              </TouchableOpacity>
            </>
          )}
          {role === 'ADMIN' && (
            <>
              <TouchableOpacity
                style={[styles.editProfileBtn, { marginTop: 8, borderColor: '#10B981', backgroundColor: 'rgba(16,185,129,0.1)' }]}
                onPress={() => navigation.navigate('AdminApplications')}
              >
                <Text style={[styles.editProfileBtnText, { color: '#10B981' }]}>CANDIDATURES FORMATEURS</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.editProfileBtn, { marginTop: 8, borderColor: '#10B981', backgroundColor: 'rgba(16,185,129,0.1)' }]}
                onPress={() => navigation.navigate('AdminInvitations')}
              >
                <Text style={[styles.editProfileBtnText, { color: '#10B981' }]}>INVITATIONS EMAIL</Text>
              </TouchableOpacity>
            </>
          )}
          <TouchableOpacity
          ...
          >
            <Text style={styles.editProfileBtnText}>MESSAGES</Text>
          </TouchableOpacity>
        </View>
